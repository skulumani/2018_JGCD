...
\end{align}
% // TL: equation eq:edge_normal is not resolved
...
% // TL: fig:uniform_mesh is missing
...
% TL: eq:translational_control undefined 
...
\end{align}
% TL: eq:inertial_velocity_dynamics undefined
...
% // TL: TODO is missing. We don't have to provide the details in this paper.
