...
The axes of the body fixed frame for the spacecraft are denoted by $\{b_1,b_2,b_3\}$, and those for the asteroid are denoted by $\{f_1,f_2,f_3\}$. 
...
\begin{itemize}
    ...
    \item \( \vc{\Omega}\in\Re \) - the angular velocity of the spacecraft body fixed frame relative to the inertial frame and represented in the dumbbell body fixed frame, \( \vc{b}_i \), and
...
\todo{Add the schematic of dumbbell that you created for the dissertation?}
