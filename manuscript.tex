...
\begin{align*}
    \dot{x} &= \ivel, \\
    \parenth{m_1 + m_2} \dot{\ivel} &= - \sum_{i=0}^2 m_i R_A \deriv{U}{\apos_i} + u_f, \\
    \dot{R} &= R \iangvel, \\
    J \dot{\iangvel} + \hat{\iangvel} J \iangvel &= \sum_{i=0}^2 m_i \hat{\spos}_i R^T R_A \deriv{U}{\apos_i} + u_m. 
\end{align*}
