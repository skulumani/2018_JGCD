...
\begin{figure}[h]
    \centering
    \subcaptionbox{Initial mesh estimate\label{fig:start}}{\includegraphics[height=0.2\textheight,width=0.5\textwidth,keepaspectratio]{figures/partial_initial.jpg}}~
